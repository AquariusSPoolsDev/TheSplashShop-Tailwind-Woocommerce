...
<!-- WISHLIST MOBILE -->
<ul
	class="shop_table cart wishlist_table wishlist_view responsive mobile shopchop-mobile-view <?php echo $show_cb ? 'with-checkbox' : ''; ?> <?php echo $no_interactions ? 'no-interactions' : ''; ?>"
	...
	?>
					...
					<div class="additional-info-wrapper">
						<?php if ($show_dateadded && $item->get_date_added()) : ?>
							<div class="product-add-to-wishlist">
								<span class="label"><?php esc_html_e('Added on:', 'yith-woocommerce-wishlist'); ?></span><br>
								<span class="value"><?php echo esc_html($item->get_date_added_formatted()); ?></span>
							</div>
						<?php endif; ?>

						<div class="wcwl-action-buttons">
							<!-- Add to cart button -->
							<?php
							/**
		...
		<p class="wishlist-empty">
			<svg class="h-20 w-20 fill-current" xmlns="http://www.w3.org/2000/svg"viewBox="0 0 512 512" width="80" height="80">
