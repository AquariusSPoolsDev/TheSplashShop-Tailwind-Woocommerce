		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_state', true ) ) : ?>
			<p class="form-row form-row-wide" id="calc_shipping_state_field">
				...
				if ( is_array( $states ) && empty( $states ) ) {
					...
					?>
					<span>
						<label for="calc_shipping_state"><?php esc_html_e( 'State', 'woocommerce' ); ?></label>
					...
					?>
					<label for="calc_shipping_state"><?php esc_html_e( 'State', 'woocommerce' ); ?></label>
					<input type="text" class="input-text" placeholder="State" value="<?php echo esc_attr( $current_r ); ?>" name="calc_shipping_state" id="calc_shipping_state" />
					<?php
				}
				?>
			</p>
