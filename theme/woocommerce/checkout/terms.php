	...
	<div class="woocommerce-terms-and-conditions-wrapper">
		...
		<?php if ( wc_terms_and_conditions_checkbox_enabled() ) : ?>
			<div class="form-row validate-required mb-4">
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox inline-flex items-start cursor-pointer">
					...
					<div class="relative shrink-0 mt-0.5 w-9 h-5 bg-neutral-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-100 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-neutral-300 after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-background after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-primary-900"></div>
